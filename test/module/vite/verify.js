...
const bundleMjsPath = path.join(__dirname, 'dist', 'bundle.mjs');
const bundleUmdPath = path.join(__dirname, 'dist', 'bundle.umd.js');
const bundlePath = fs.existsSync(bundleMjsPath) ? bundleMjsPath : bundleUmdPath;
